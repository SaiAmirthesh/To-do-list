      ...
      <div className="w-full max-w-md bg-gray-800 rounded-xl shadow-2xl p-8">
        ...
        <div className="space-y-4">
          <input
            ...
            className="w-full px-4 py-3 border bg-gray-700 border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent transition duration-200 text-white"
          />
